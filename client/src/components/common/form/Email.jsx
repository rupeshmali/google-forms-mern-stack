            ...
            <div className='flex justify-between p-9 rounded-3xl bg-white h-[400px] w-[1040px]'>
                ...
                <div className='flex flex-col pt-20 gap-10'>
                    <div className='flex flex-col gap-2'>
                        <input onChange={handleChange} value={email} type="text" placeholder='Email or phone' className='border-stone-900 border w-[450px] rounded px-4 py-4 placeholder:text-slate-700' />
